...
2.  **RFI (Rete Ferroviaria Italiana):** Zusätzliche Abfrage der offiziellen italienischen Bahn-Monitore und über Viaggiatreno (ViaggiaTreno/IecHub), um eine höhere Genauigkeit bei Verspätungsangaben auf dem staatlichen Schienennetz zu erreichen.
